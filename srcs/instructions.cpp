...
instruction instructions[0x100] = 
{
    ...
    [0X1E] = {LD, AM_R_D8, E,},
    [0X1F] = {RRA,},
    [0X20] = {JR, AM_D8, RT_NONE, RT_NONE, CT_NZ},
    [0X21] = {LD, AM_R_D16, HL,},
    ...
    [0X26] = {LD, AM_R_D8, H},
    [0X27] = {DAA,},
    [0X28] = {JR, AM_D8, RT_NONE, RT_NONE, CT_Z},
    ...
    [0X2E] = {LD, AM_R_D8, L},
    [0X2F] = {CPL,},
    [0X30] = {JR, AM_D8, RT_NONE, RT_NONE, CT_NC},
    [0X31] = {LD, AM_R_D16, SP,},
    ...
    [0X36] = {LD, AM_MR_D8, HL,},
    [0X37] = {SCF,},
    [0X38] = {JR, AM_D8, RT_NONE, RT_NONE, CT_C},
    ...
    [0XC5] = {PUSH, AM_R, BC,},
    [0XC6] = {ADD, AM_R_D8, A,},
    [0XC7] = {RST, AM_IMP, RT_NONE, RT_NONE, CT_NONE, 0x00},
    ...
    [0XCD] = {CALL, AM_D16,},
    [0XCE] = {ADC, AM_R_D8, A,},
    [0XCF] = {RST, AM_IMP, RT_NONE, RT_NONE, CT_NONE, 0x08},
    ...
    [0XD5] = {PUSH, AM_R, DE,},
    [0XD6] = {SUB, AM_D8,},
    [0XD7] = {RST, AM_IMP, RT_NONE, RT_NONE, CT_NONE, 0x10},
    ...
    [0xDD] = {IT_NONE},
    [0XDE] = {SBC, AM_R_D8, A,},
    [0XDF] = {RST, AM_IMP, RT_NONE, RT_NONE, CT_NONE, 0x18},
    ...
    [0XE5] = {PUSH, AM_R, HL,},
    [0XE6] = {AND, AM_D8,},
    [0XE7] = {RST, AM_IMP, RT_NONE, RT_NONE, CT_NONE, 0x20},
    ...
    [0xED] = {IT_NONE},
    [0XEE] = {XOR, AM_D8,},
    [0XEF] = {RST, AM_IMP, RT_NONE, RT_NONE, CT_NONE, 0x28},
    ...
    [0XF5] = {PUSH, AM_R, AF,},
    [0XF6] = {OR, AM_D8,},
    [0XF7] = {RST, AM_IMP, RT_NONE, RT_NONE, CT_NONE, 0x30},
    [0XF8] = {LD, AM_HL_SPR,},
    ...
    [0xFD] = {IT_NONE},
    [0XFE] = {CP, AM_D8,},
    [0XFF] = {RST, AM_IMP, RT_NONE, RT_NONE, CT_NONE, 0x38 },
};
